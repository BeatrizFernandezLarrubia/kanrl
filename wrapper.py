...
class TransformObservation(gym.ObservationWrapper, gym.utils.RecordConstructorArgs): # [docs]: https://gymnasium.farama.org/api/wrappers/observation_wrappers/#gymnasium.wrappers.TransformObservation
